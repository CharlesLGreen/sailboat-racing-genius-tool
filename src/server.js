...
app.get("/coaching-beta", (req, res) => {
  const lang = getLang(req);
  res.send(renderPage(`<div class="container" style="max-width:700px;">
    <div style="text-align:center;margin-bottom:28px;">
      <img src="/logo.jpg" alt="Snipeovation" style="height:64px;border-radius:10px;margin-bottom:12px;">
      <h2 style="color:#0b3d6e;font-size:1.6rem;margin:0 0 4px;">AI Coaching + Vakaros</h2>
      <p style="color:#059669;font-weight:700;font-size:1.1rem;margin:0;">Now in Beta</p>
    </div>

    <div style="background:linear-gradient(135deg,#f0f7ff,#e6f0fa);border:2px solid #93c5fd;border-radius:16px;padding:24px;margin-bottom:24px;">
      <p style="color:#0b3d6e;font-size:1.05rem;font-weight:600;margin:0 0 12px;">Snipeovation is debuting AI-powered sailing coaching at the Don Q Regatta.</p>
      <p style="color:#444;font-size:0.95rem;line-height:1.7;margin:0;">For the first time, Snipe sailors can get personalized coaching reports generated by Claude AI &mdash; analyzing your race history, practice notes, tuning settings, and Vakaros telemetry data to deliver specific, actionable advice tailored to your sailing.</p>
    </div>

    <h3 style="color:#0b3d6e;margin-bottom:12px;">How It Works</h3>

    <div style="display:flex;flex-direction:column;gap:14px;margin-bottom:28px;">
      <div style="display:flex;align-items:flex-start;gap:14px;background:white;border-radius:12px;padding:16px;box-shadow:0 2px 8px rgba(0,0,0,0.05);">
        <span style="font-size:1.8rem;flex-shrink:0;">&#128203;</span>
        <div>
          <p style="font-weight:700;color:#0b3d6e;margin:0 0 4px;">Log Your Races</p>
          <p style="color:#555;font-size:0.9rem;margin:0;">Use Quick Race Entry to log results in under 10 seconds &mdash; right from the water on your phone.</p>
        </div>
      </div>
      <div style="display:flex;align-items:flex-start;gap:14px;background:white;border-radius:12px;padding:16px;box-shadow:0 2px 8px rgba(0,0,0,0.05);">
        <span style="font-size:1.8rem;flex-shrink:0;">&#128225;</span>
        <div>
          <p style="font-weight:700;color:#0b3d6e;margin:0 0 4px;">Share Your Vakaros Data</p>
          <p style="color:#555;font-size:0.9rem;margin:0;">After sailing, open Vakaros Connect &rarr; Sessions &rarr; Export &rarr; Share &rarr; choose Snipeovation. Your speed, heel, VMG, and GPS data flow in automatically.</p>
        </div>
      </div>
      <div style="display:flex;align-items:flex-start;gap:14px;background:white;border-radius:12px;padding:16px;box-shadow:0 2px 8px rgba(0,0,0,0.05);">
        <span style="font-size:1.8rem;flex-shrink:0;">&#129302;</span>
        <div>
          <p style="font-weight:700;color:#0b3d6e;margin:0 0 4px;">Get AI Coaching</p>
          <p style="color:#555;font-size:0.9rem;margin:0;">Claude AI analyzes everything &mdash; your results trend, tuning choices, practice notes, and Vakaros telemetry &mdash; and generates a personalized coaching report with Snipe-specific advice.</p>
        </div>
      </div>
    </div>

    <h3 style="color:#0b3d6e;margin-bottom:12px;">What the Coach Analyzes</h3>
    <div style="background:white;border-radius:12px;padding:20px;box-shadow:0 2px 8px rgba(0,0,0,0.05);margin-bottom:28px;">
      <ul style="list-style:none;padding:0;margin:0;display:flex;flex-direction:column;gap:8px;">
        <li style="font-size:0.93rem;color:#333;">&#9989; <strong>Race results &amp; trends</strong> &mdash; Are you improving? Where do results drop off?</li>
        <li style="font-size:0.93rem;color:#333;">&#9989; <strong>Tuning patterns</strong> &mdash; Mast rake, shroud tension, sail selection by wind range</li>
        <li style="font-size:0.93rem;color:#333;">&#9989; <strong>Practice session notes</strong> &mdash; What you've been working on and what's clicking</li>
        <li style="font-size:0.93rem;color:#333;">&#9989; <strong>Upwind &amp; downwind performance</strong> &mdash; VMG, pointing, speed consistency</li>
        <li style="font-size:0.93rem;color:#333;">&#9989; <strong>Boat handling</strong> &mdash; Tack/gybe counts, heel angle consistency, starts</li>
        <li style="font-size:0.93rem;color:#333;">&#128225; <strong>Vakaros telemetry trends</strong> &mdash; Speed, heel, VMG tracked across every session</li>
      </ul>
    </div>

    <div style="background:#f0fdf4;border:2px solid #86efac;border-radius:14px;padding:20px;margin-bottom:28px;">
      <h3 style="color:#059669;margin:0 0 8px;font-size:1.05rem;">&#9973; Debuting at the Don Q Regatta</h3>
      <p style="color:#444;font-size:0.93rem;line-height:1.6;margin:0;">We're launching the AI Coaching + Vakaros beta at the Don Q. Sailors participating can log their races, share Vakaros sessions, and get their first AI coaching report during the regatta. Your feedback will shape how this feature evolves.</p>
    </div>

    <div style="background:white;border-radius:12px;padding:20px;box-shadow:0 2px 8px rgba(0,0,0,0.05);margin-bottom:28px;">
      <h3 style="color:#0b3d6e;margin:0 0 8px;">No Vakaros? No Problem.</h3>
      <p style="color:#555;font-size:0.93rem;line-height:1.6;margin:0;">AI Coaching works with just your race logs and practice notes. Vakaros adds optional telemetry depth &mdash; speed, heel angle, VMG, tack efficiency &mdash; but it's not required. Every Snipe sailor can benefit.</p>
    </div>

    <div style="text-align:center;margin-bottom:16px;">
      <a href="/register" class="btn btn-primary" style="font-size:1.1rem;padding:14px 36px;margin-bottom:10px;display:inline-block;">Create Free Account</a>
      <br>
      <a href="/login" style="color:#1a6fb5;font-weight:600;font-size:0.95rem;">Already have an account? Log in</a>
    </div>
    <p style="text-align:center;color:#999;font-size:0.8rem;">Snipeovation AI Coaching is powered by Claude AI from Anthropic.</p>
...
function logFormPage(data, error, userWireDefault, lang) {
  ...
  <label>⛵ Snipe Builder</label>
  <select name="snipe_builder" style="padding:10px;border:1p<input type="text" id="task-input" placeholder="Enter task description" style="flex:1;min-width:200px;padding:10px;border:1px s
