...
app.get("/trustee", (req, res) => {
  res.send('<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Trustee Instructions - Snipeovation</title><style>body{font-family:Arial,sans-serif;max-width:960px;margin:0 auto;padding:0;color:#333}.nav-tabs{background:#1B4F8A;padding:10px 20px}.nav-tabs a{color:white;text-decoration:none;margin-right:16px;padding:8px 16px;border-radius:4px;font-weight:bold;background:#2E74B5;display:inline-block}.nav-tabs a.active{background:#0d3b6e}.content{padding:30px}h1{color:#1B4F8A;border-bottom:3px solid #1B4F8A;padding-bottom:10px}h2{color:#2E74B5;margin-top:32px}.alert-red{background:#FFE8E8;border-left:6px solid #CC0000;padding:12px 16px;margin:16px 0;border-radius:4px}.alert-yellow{background:#FFF3CD;border-left:6px solid #FFC107;padding:12px 16px;margin:16px 0;border-radius:4px}.alert-green{background:#E8F4E8;border-left:6px solid #28A745;padding:12px 16px;margin:16px 0;border-radius:4px}table{width:100%;border-collapse:collapse;margin:16px 0}th{background:#1B4F8A;color:white;padding:10px 12px;text-align:left}td{border:1px solid #ccc;padding:8px 12px;vertical-align:top}tr:nth-child(even) td{background:#F8FAFC}.crit-critical{background:#FFE8E8!important;color:#CC0000;font-weight:bold}.crit-high{background:#FFF3CD!important;color:#996600;font-weight:bold}.crit-medium{background:#E8F4E8!important;
app.get("/trustee/written", (req, res) => {
  res.send('<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Written Instructions - Trustee - Snipeovation</title><style>body{font-family:Arial,sans-serif;max-width:960px;margin:0 auto;padding:0;color:#333}.nav-tabs{background:#1B4F8A;padding:10px 20px}.nav-tabs a{color:white;text-decoration:none;margin-right:16px;padding:8px 16px;border-radius:4px;font-weight:bold;background:#2E74B5;display:inline-block}.nav-tabs a.active{background:#0d3b6e}.content{padding:30px}h1{color:#1B4F8A;border-bottom:3px solid #1B4F8A;padding-bottom:10px}h2{color:#2E74B5;margin-top:32px}.alert-green{background:#E8F4E8;border-left:6px solid #28A745;padding:12px 16px;margin:16px 0;border-radius:4px}.alert-yellow{background:#FFF3CD;border-left:6px solid #FFC107;padding:12px 16px;margin:16px 0;border-radius:4px}.doc-card{border:2px solid #1B4F8A;border-radius:8px;padding:24px;margin:24px 0;background:#F0F4FA}.doc-card h3{color:#1B4F8A;margin-top:0}.location{background:#1E1E1E;color:#00FF88;padding:10px 16px;border-radius:4px;font-family:monospace;margin:8px 0;display:block}</style></head><body><div class="nav-tabs"><a href="/trustee">📋 Instructions</a><a href="/trustee/written" class="active">📄 Written Instructions</a></div><div class="content"><h1>Written Instructions Document</h1><p>The full successor trustee instructions are available as a Word document stored securely in Dropbox.</p><div class="doc-card"><h3>📄 Trustee-Instructions-Snipeovation-CrewCollege.docx</h3><p><strong>Location on Charles Green's computer:</strong></p><span class="location">C:\Users\ADMIN\Dropbox\Claude\Trustee-Instructions-Snipeovation-CrewCollege.docx</span><p><strong>Dropbox online:</strong></p><span class="location">https://www.dropbox.com then Claude folder</span></div><h2>How to Access</h2><div class="alert-yellow"><strong>You will need Charles Green's Dropbox credentials.</strong> Request through his estate documents or attorney.</div><ol><li>Go to https://www.dropbox.com and log in.</li><li>Navigate to the Claude folder.</li><li>Find Trustee-Instructions-Snipeovation-CrewCollege.docx and download it.</li></ol><h2>Document Contains</h2><ol><li>Overview of the Two Websites</li><li>Where Everything Is Stored</li><li>Accounts and Services to Access</li><li>How to Keep the Sites Running</li><li>Domain Name and DNS</li><li>Billing and Financial Notes</li><li>Emergency Procedures</li><li>Summary: What Is Stored Where</li></ol><div class="alert-green"><strong>TIP:</strong> Print this document and store a physical copy with your estate planning documents.</div></div></body></html>');
});
// Start server
