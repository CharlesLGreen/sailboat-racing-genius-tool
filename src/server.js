...
app.get('/trustee',(req,res)=>{res.send('<html><head><style>body{font-family:Arial,sans-serif;margin:0}.tabs{background:#1B4F8A;padding:10px 20px;display:flex;gap:10px}.tabs a{color:white;padding:8px 18px;border-radius:4px;text-decoration:none;font-weight:bold;background:#2E74B5}.tabs a.active{background:#0d3b6e}.content{padding:30px;max-width:960px;margin:0 auto}h1{color:#1B4F8A;border-bottom:3px solid #1B4F8A;padding-bottom:10px}h2{color:#2E74B5;margin-top:32px}.ar{background:#FFE8E8;border-left:6px solid #CC0000;padding:12px 16px;margin:16px 0;border-radius:4px}.ay{background:#FFF3CD;border-left:6px solid #FFC107;padding:12px 16px;margin:16px 0;border-radius:4px}.ag{background:#E8F4E8;border-left:6px solid #28A745;padding:12px 16px;margin:16px 0;border-radius:4px}table{width:100%;border-collapse:collapse;margin:16px 0}th{background:#1B4F8A;color:white;padding:10px 12px;text-align:left}td{border:1px solid #ccc;padding:8px 12px;vertical-align:top}tr:nth-child(even) td{background:#F8FAFC}.cc{background:#FFE8E8!important;color:#CC0000;font-weight:bold}.ch{background:#FFF3CD!important;color:#996600;font-weight:bold}.cm{background:#E8F4E8!important;color:#28A745;font-weight:bold}code{background:#1E1E1E;color:#00FF88;padding:2px 8px;border-radius:3px;font-family:monospace;font-size:.9em}</style></head><body><div class=tabs><a class=active href=/trustee>Instructions</a><a href=/trustee/written>Written Instructions</a></div><div class=content><div class=ar><strong>IMPORTANT:</strong> This page contains instructions for keeping Snipeovation.com and Crew College operational if Charles Green becomes incapacitated or unavailable.</div><h1>1. Overview of the Two Websites</h1><table><tr><th></th><th>Snipeovation.com</th><th>Crew College</th></tr><tr><td><strong>Purpose</strong></td><td>Sailboat racing log, tuning guides, performance metrics for Snipe sailors</td><td>Online crew training with diplomas</td></tr><tr><td><strong>Hosting</strong></td><td>Railway.com (snipe-app)</td><td>Vercel.com</td></tr><tr><td><strong>Domain</strong></td><td>snipeovation.com</td><td>TBD</td></tr><tr><td><strong>Tech</strong></td><td>Node.js / Express / SQLite + PostgreSQL</td><td>Next.js / React</td></tr></table><h1>2. Where Everything Is Stored</h1><h2>Source Code</h2><table><tr><th>Asset</th><th>Location</th></tr><tr><td><strong>Snipe Genius Tool</strong></td><td>GitHub: https://github.com/CharlesLGreen/Snipe-Genius-tool -- Dropbox: Dropbox/Claude/Snipe Genius Tool/</td></tr><tr><td><strong>Crew College</strong></td><td>GitHub: https://github.com/CharlesLGreen/Crew-College -- Dropbox: Dropbox/Claude/Crew-College/</td></tr><tr><td><strong>Trustee Document</strong></td><td>Dropbox/Claude/Trustee-Instructions-Snipeovation-CrewCollege.docx</td></tr></table><h2>User Data</h2><div class=ag><strong>NOTE:</strong> All sailor race logs, boat photos, and accounts are on Railway persistent volume - NOT in GitHub.</div><table><tr><th>Database</th><th>Location</th><th>Contains</th></tr><tr><td>SQLite (snipe.db)</td><td>Railway persistent volume</td><td>User accounts, race logs, boat photos, regatta records, tasks</td></tr><tr><td>PostgreSQL</td><td>Railway Postgres service</td><td>Session data</td></tr><tr><td>Crew College</td><td>Vercel cloud</td><td>Student records, diplomas</td></tr></table><h1>3. Accounts and Services</h1><div class=ay><strong>SECURITY:</strong> Passwords not stored here. Request via Charles Green estate documents or attorney.</div><table><tr><th>Service</th><th>URL</th><th>Purpose</th></tr><tr><td><strong>Railway.com</strong></td><td>https://railway.com</
powershell
$p = 'C:\Users\ADMIN\Dropbox\Claude\Snipe Genius Tool\sailboat-racing-genius-tool-main\src\server.js'
$c = [IO.File]::ReadAllText($p)
$old = "app.get('/trustee',(req,res)=>{res.send('<html><body><div style=""background:#1B4F8A;padding:10px""><a href=""/trustee"" style=""color:white;padding:8px;font-weight:bold;background:#0d3b6e;border-radius:4px;text-decoration:none"">Instructions</a> <a href=""/trustee/written"" style=""color:white;padding:8px;font-weight:bold;background:#2E74B5;border-radius:4px;text-decoration:none"">Written Instructions</a></div><div style=""padding:30px""><h1>Trustee Instructions</h1><p>Click Written Instructions tab above for the full document.</p></div></body></html>');})"
$new = @'
app.get('/trustee',(req,res)=>{res.send('<html><head><style>body{font-family:Arial,sans-serif;margin:0}.tabs{background:#1B4F8A;padding:10px 20px;display:flex;gap:10px}.tabs a{color:white;padding:8px 18px;border-radius:4px;text-decoration:none;font-weight:bold;background:#2E74B5}.tabs a.active{background:#0d3b6e}.content{padding:30px;max-width:960px;margin:0 auto}h1{color:#1B4F8A;border-bottom:3px solid #1B4F8A;padding-bottom:10px}h2{color:#2E74B5;margin-top:32px}.ar{background:#FFE8E8;border-left:6px solid #CC0000;padding:12px 16px;margin:16px 0;border-radius:4px}.ay{background:#FFF3CD;border-left:6px solid #FFC107;padding:12px 16px;margin:16px 0;border-radius:4px}.ag{background:#E8F4E8;border-left:6px solid #28A745;padding:12px 16px;margin:16px 0;border-radius:4px}table{width:100%;border-collapse:collapse;margin:16px 0}th{background:#1B4F8A;color:white;padding:10px 12px;text-align:left}td{border:1px solid #ccc;padding:8px 12px;vertical-align:top}tr:nth-child(even) td{background:#F8FAFC}.cc{background:#FFE8E8!important;color:#CC0000;font-weight:bold}.ch{background:#FFF3CD!important;color:#996600;font-weight:bold}.cm{background:#E8F4E8!important;color:#28A745;font-weight:bold}code{background:#1E1E1E;color:#00FF88;padding:2px 8px;border-radius:3px;font-family:monospace;font-size:.9em}</style></head><body><div class=tabs><a class=active href=/trustee>Instructions</a><a href=/trustee/written>Written Instructions</a></div><div class=content><div class=ar><strong>IMPORTANT:</strong> This page contains instructions for keeping Snipeovation.com and Crew College operational if Charles Green becomes incapacitated or unavailable.</div><h1>1. Overview of the Two Websites</h1><table><tr><th></th><th>Snipeovation.com</th><th>Crew College</th></tr><tr><td><strong>Purpose</strong></td><td>Sailboat racing log, tuning guides, performance metrics for Snipe sailors</td><td>Online crew training with diplomas</td></tr><tr><td><strong>Hosting</strong></td><td>Railway.com (snipe-app)</td><td>Vercel.com</td></tr><tr><td><strong>Domain</strong></td><td>snipeovation.com</td><td>TBD</td></tr><tr><td><strong>Tech</strong></td><td>Node.js / Express / SQLite + PostgreSQL</td><td>Next.js / React</td></tr></table><h1>2. Where Everything Is Stored</h1><h2>Source Code</h2><table><tr><th>Asset</th><th>Location</th></tr><tr><td><strong>Snipe Genius Tool</strong></td><td>GitHub: https://github.com/CharlesLGreen/Snipe-Genius-tool -- Dropbox: Dropbox/Claude/Snipe Genius Tool/</td></tr><tr><td><strong>Crew College</strong></td><td>GitHub: https://github.com/CharlesLGreen/Crew-College -- Dropbox: Dropbox/Claude/Crew-College/</td></tr><tr><td><strong>Trustee Document</strong></td><td>Dropbox/Claude/Trustee-Instructions-Snipeovation-CrewCollege.docx</td></tr></table><h2>User Data</h2><div class=ag><strong>NOTE:</strong> All sailor race logs, boat photos, and accounts are on Railway persistent volume - NOT in GitHub.</div><table><tr><th>Database</th><th>Location</th><th>Contains</th></tr><tr><td>SQLite (snipe.db)</td><td>Railway persistent volume</td><td>User accounts, race logs, boat photos, regatta records, tasks</td></tr><tr><td>PostgreSQL</td><td>Railway Postgres service</td><td>Session data</td></tr><tr><td>Crew College</td><td>Vercel cloud</td><td>Student records, diplomas</td></tr></table><h1>3. Accounts and Services</h1><div class=ay><strong>SECURITY:</strong> Passwords not stored here. Request via Charles Green estate documents or attorney.</div><table><tr><th>Service</th><th>URL</th><th>Purpose</th></tr><tr><td><strong>Railway.com</strong></td><td>https://railway.com</td><td>Hosts Snipe Genius Tool (project: adaptable-flow)</td></tr><tr><td><strong>GitHub</strong></td><td>https://github.com/CharlesLGreen</td><td>All source code</td></tr><tr><td><strong>Vercel</strong></td><td>https://vercel.com</td><td>Hosts Crew College</td></tr><tr><td><strong>Dropbox</strong></td><td>https://dropbox.com</td><td>File backups</td></tr><tr><td><strong>Domain Registrar</strong></td><td>Where snipeovation.com registered</td><td>Domain renewal and DNS</td></tr><tr><td><strong>Claude.ai</strong></td><td>https://claude.ai</td><td>AI assistant for maintenance</td></tr></table><h1>4. How to Keep the Sites Running</h1><h2>Normal Operations</h2><p>Both sites run automatically. Railway restarts Snipeovation if it crashes. Vercel keeps Crew College running. Domain must be renewed annually.</p><h2>If a Site Goes Down</h2><p><strong>Snipeovation:</strong> Log into Railway.com, click snipe-app, look for Crashed status, click Redeploy.</p><p><strong>Crew College:</strong> Log into Vercel.com, find project, click Redeploy.</p><h2>Making Updates Using Claude AI</h2><div class=ag><strong>RECOMMENDED:</strong> Go to https://claude.ai, log in, describe the problem in plain English. Claude will guide you step by step.</div><h2>Update Workflow</h2><table><tr><th>Command</th><th>What It Does</th></tr><tr><td><code>git add .</code></td><td>Stage all changes</td></tr><tr><td><code>git commit -m "note"</code></td><td>Save with description</td></tr><tr><td><code>git push</code></td><td>Upload to GitHub</td></tr><tr><td><code>railway up</code></td><td>Deploy to live Snipeovation site</td></tr></table><p><strong>Snipe Tool:</strong> cd "C:/Users/ADMIN/Dropbox/Claude/Snipe Genius Tool/sailboat-racing-genius-tool-main"</p><p><strong>Crew College:</strong> cd "C:/Users/ADMIN/Dropbox/Claude/Crew-College" (git push auto-deploys)</p><h1>5. Domain Name and DNS</h1><div class=ar><strong>CRITICAL:</strong> If snipeovation.com expires both sites go offline. Set 60-day advance renewal reminder.</div><table><tr><th>Setting</th><th>Value</th></tr><tr><td>Domain</td><td>snipeovation.com</td></tr><tr><td>DNS</td><td>CNAME pointing to snipe-app-production.up.railway.app</td></tr><tr><td>Renewal</td><td>Annual</td></tr></table><h1>6. Billing</h1><table><tr><th>Service</th><th>Billing</th><th>Notes</th></tr><tr><td>Railway.com</td><td>Monthly</td><td>Must pay to keep Snipeovation online</td></tr><tr><td>Vercel.com</td><td>Free/Monthly</td><td>Hosts Crew College</td></tr><tr><td>Domain Registrar</td><td>Annual</td><td>snipeovation.com - critical</td></tr><tr><td>Dropbox</td><td>Annual/Monthly</td><td>Code backups</td></tr><tr><td>Claude.ai</td><td>Monthly</td><td>AI maintenance assistant</td></tr></table><h1>7. Emergency Procedures</h1><ul><li>Contact a local web developer with this page and the GitHub repos</li><li>Railway support: https://help.railway.com</li><li>Vercel support: https://vercel.com/support</li><li>GitHub repos have all code to rebuild from scratch</li></ul><table><tr><th>Command</th><th>What It Does</th></tr><tr><td><code>git status</code></td><td>See changed files</td></tr><tr><td><code>git add .</code></td><td>Stage changes</td></tr><tr><td><code>git commit -m "note"</code></td><td>Save with description</td></tr><tr><td><code>git push</code></td><td>Upload to GitHub</td></tr><tr><td><code>railway up</code></td><td>Deploy to Snipeovation</td></tr><tr><td><code>railway logs</code></td><td>View errors</td></tr></table><h1>8. Summary: What Is Stored Where</h1><table><tr><th>Asset</th><th>Primary</th><th>Backup</th><th>Criticality</th></tr><tr><td>Snipe Tool Code</td><td>GitHub</td><td>Dropbox/Claude/Snipe Genius Tool/</td><td class=ch>HIGH</td></tr><tr><td>Crew College Code</td><td>GitHub</td><td>Dropbox/Claude/Crew-College/</td><td class=ch>HIGH</td></tr><tr><td>User Race Logs</td><td>Railway volume</td><td>Railway managed</td><td class=cc>CRITICAL</td></tr><tr><td>Boat Photos</td><td>Railway volume</td><td>Railway managed</td><td class=ch>HIGH</td></tr><tr><td>Hero/Logo Images</td><td>GitHub repo</td><td>Dropbox/Claude/</td><td class=cm>MEDIUM</td></tr><tr><td>Trustee Document</td><td>Dropbox/Claude/</td><td>snipeovation.com/trustee</td><td class=ch>HIGH</td></tr><tr><td>Domain</td><td>Domain Registrar</td><td>N/A</td><td class=cc>CRITICAL</td></tr></table><div class=ag style="margin-top:32px"><strong>FINAL NOTE:</strong> Most important: pay Railway and domain bills on time, keep GitHub credentials accessible. When in doubt use Claude AI at https://claude.ai.</div><hr><p style="color:#888;font-size:.85em;text-align:center"><em>Prepared by Charles L. Green, March 2026.</em></p></div></body></html>');});
